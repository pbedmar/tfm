...
class ESIOS(object):
    ...
    def get_indicators(self):
        ...
        :return:
        """
        fname = 'datalake/raw/esios/indicators.pickle'
        import os
    ...
    def get_data(self, indicator, start, end):
        ...
        if type(start) is datetime.datetime:
            start_str = start.astimezone().isoformat()
        else:
            start_str = start
        
        if type(end) is datetime.datetime:
            end_str = end.astimezone().isoformat()
        else:
            end_str = end
    ...
    def get_multiple_series(self, indicators, start, end):
        ...
        for indicator in indicators:
            ...
            if df_new is not None:
                ...
                # save
                file_handler = open("datalake/raw/esios/" + str(indicator) + ".pkl", "wb")
